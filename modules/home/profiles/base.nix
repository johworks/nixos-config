...
}:
{
  ...
  config = {
    ...
    # Breaks because codex tries to write to this nix store file
    ...
    home.file.".ssh/known_hosts".text = lib.mkDefault ''
      ...
      nuc,192.168.10.1 ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFVkF+MzN86FBsZgSVqvAVCGEgE+1O/zV7YqDIR1MOuF root@nixos
    '';
